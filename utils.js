function responseLiteralWithBodyOnly(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
...
function responseLiteralWithUTF16BodyResponse(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        // if no request matcher is specified then every request matched
        "httpResponse": {
...
function jsonResponseWithUTF8Body(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "method": "GET",
...
function responseLiteralWithHeader(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        // if no request matcher is specified then every request matched
        "httpResponse": {
...
function responseLiteralWithCookie(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        // if no request matcher is specified then every request matched
        "httpResponse": {
...
function responseLiteralWithStatusCodeAndReasonPhrase(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "method": "POST",
...
function responseLiteralWithBinaryPNGBody(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
...
function responseLiteralWith10SecondDelay(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "path": "/some/path"
...
function respondDifferentlyForSameRequest(port) {
    var client = require('mockserver-client').mockServerClient("localhost", port);
...
function responseLiteralWithConnectionOptionsToSuppressHeaders(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "path": "/some/path"
...
function responseLiteralWithConnectionOptionsToOverrideHeaders(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "path": "/some/path"
...
function responseLiteralWithConnectionOptionsToCloseSocket(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "path": "/some/path"
...
function javascriptTemplatedResponse(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {
            "path": "/some/path"
...
function javascriptTemplatedResponseWithDelay(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
...
function velocityTemplatedResponse(port) {
    var mockServerClient = require('mockserver-client').mockServerClient;
    mockServerClient("localhost", port).mockAnyResponse({
        "httpRequest": {"path": "/some/path"},
        "httpResponseTemplate": {
...
module.exports = {
    responseLiteralWithBodyOnly,
    responseLiteralWithUTF16BodyResponse,
    jsonResponseWithUTF8Body,
    responseLiteralWithHeader,
    responseLiteralWithCookie,
    responseLiteralWithStatusCodeAndReasonPhrase,
    responseLiteralWithBinaryPNGBody,
    responseLiteralWith10SecondDelay,
    respondDifferentlyForSameRequest,
    responseLiteralWithConnectionOptionsToSuppressHeaders,
    responseLiteralWithConnectionOptionsToOverrideHeaders,
    responseLiteralWithConnectionOptionsToCloseSocket,
    javascriptTemplatedResponse,
    javascriptTemplatedResponseWithDelay,
    velocityTemplatedResponse
};